...
import SuaBangGia from './SuaBangGia';
import XemBangGia from './XemBangGia';
import { BaseRow } from '@app/components/common/BaseRow/BaseRow';
import { BaseCol } from '@app/components/common/BaseCol/BaseCol';
import { useTranslation } from 'react-i18next';
import { getBangGiaColumns } from './config/columns.config';

const DanhSachBangGia = ({ path, permission }: { path: string; permission: Actions }) => {
  ...
  const defaultColumns = getBangGiaColumns(
    {
      page: filter.page,
...
export default DanhSachBangGia;
