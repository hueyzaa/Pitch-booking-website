...
import ThemBangGia from './ThemBangGia';
import DanhSachBangGia from './DanhSachBangGia';
...
const BangGia = () => {
  const path = API_URL.BANG_GIA;
  const page = 'common.bang-gia';
          ...
          <BaseCol span={24}>
            <BaseRow justify='space-between' align='middle'>
              ...
              <BaseCol style={{ display: 'flex', gap: '1rem' }}>
                ...
                {permission.create && <ThemBangGia path={path} />}
              </BaseCol>
            </BaseRow>
          </BaseCol>
          <BaseCol span={24}>
            {permission.show && <DanhSachBangGia path={path} permission={permission}  />}
          </BaseCol>
        </BaseRow>
      </BaseCard>
    </>
