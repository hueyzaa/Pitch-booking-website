...
import ThemLoaiSan from './ThemLoaiSan';
import DanhSachLoaiSan from './DanhSachLoaiSan';
...
const LoaiSan = () => {
  const path = API_URL.LOAI_SAN;
  const page = 'common.loai-san';
          ...
          <BaseCol span={24}>
            <BaseRow justify='space-between' align='middle'>
              ...
              <BaseCol style={{ display: 'flex', gap: '1rem' }}>
                ...
                {permission.create && <ThemLoaiSan path={path} />}
              </BaseCol>
            </BaseRow>
          </BaseCol>
          <BaseCol span={24}>{permission.show && <DanhSachLoaiSan path={path} permission={permission} />}</BaseCol>
        </BaseRow>
      </BaseCard>
    </>
  );
