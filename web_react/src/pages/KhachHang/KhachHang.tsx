...
const KhachHang = () => {
  const path = API_URL.KHACH_HANG;
  const page = 'common.khach-hang';
          ...
          <BaseCol span={24}>
            <BaseRow justify='space-between' align='middle'>
              ...
              <BaseCol style={{ display: 'flex', gap: '1rem' }}>
                ...
                {permission.create && <ThemKhachHang path={path} />}
              </BaseCol>
            </BaseRow>
          </BaseCol>
          <BaseCol span={24}>
            {permission.show && <DanhSachKhachHang path={path} permission={permission}  />}
          </BaseCol>
        </BaseRow>
      </BaseCard>
    </>
