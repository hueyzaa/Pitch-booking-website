...
import ThemQuanLyGia from './ThemQuanLyGia';
import DanhSachQuanLyGia from './DanhSachQuanLyGia';
...
const QuanLyGia = () => {
  const path = API_URL.QUAN_LY_GIA;
  const page = 'common.quan-ly-gia';
          ...
          <BaseCol span={24}>
            <BaseRow justify='space-between' align='middle'>
              ...
              <BaseCol style={{ display: 'flex', gap: '1rem' }}>
                ...
                {permission.create && <ThemQuanLyGia path={path} />}
              </BaseCol>
            </BaseRow>
          </BaseCol>
          <BaseCol span={24}>
            {permission.show && <DanhSachQuanLyGia path={path} permission={permission}  />}
          </BaseCol>
        </BaseRow>
      </BaseCard>
    </>
