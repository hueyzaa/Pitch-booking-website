...
const DanhGia = () => {
  const path = API_URL.DANH_GIA;
  const page = 'common.danh-gia';
          ...
          <BaseCol span={24}>
            <BaseRow justify='space-between' align='middle'>
              ...
              <BaseCol style={{ display: 'flex', gap: '1rem' }}>
                ...
                {/* Ẩn nút Thêm vì đánh giá chủ yếu từ web public */}
              </BaseCol>
            </BaseRow>
          </BaseCol>
          <BaseCol span={24}>
            {permission.show && <DanhSachDanhGia path={path} permission={permission}  />}
          </BaseCol>
        </BaseRow>
      </BaseCard>
    </>
