...
import ThemDatSan from './ThemDatSan';
import DanhSachDatSan from './DanhSachDatSan';
...
const DatSan = () => {
  const path = API_URL.DAT_SAN;
  const page = 'common.dat-san';
          ...
          <BaseCol span={24}>
            <BaseRow justify='space-between' align='middle'>
              ...
              <BaseCol style={{ display: 'flex', gap: '1rem' }}>
                ...
                {permission.create && <ThemDatSan path={path} />}
              </BaseCol>
            </BaseRow>
          </BaseCol>
          <BaseCol span={24}>
            {permission.show && <DanhSachDatSan path={path} permission={permission}  />}
          </BaseCol>
        </BaseRow>
      </BaseCard>
    </>
