import{u as f,a as b,r as w,A as v,B as y,b_ as $,n as j,j as n,m as a,k as d,F as o,D as _,q as F,o as x,s as r,N as z,z as P}from"./index-DFD43UYP.js";import{B as l}from"./BaseForm-BS_rT-Qb.js";import{p as u}from"./patterns-CiPeFOmw.js";import{C as k}from"./auth.api-CSPjSmRN.js";import{B as I}from"./BaseInput-NAQkEY-m.js";import{I as L}from"./InputPassword-CTGHH4M5.js";import{A as S}from"./AuthLayout-BMyswacw.js";import"./v4-C6aID195.js";import"./AuthLayout.styles-CU_Glx0s.js";const T=()=>{const s=f(),e=b(),[c,i]=w.useState(!1);return{handleSubmit:async p=>{try{i(!0);const t=await k({...p,is_first_change:1});(t==null?void 0:t.code)===200&&((await v.post(`${y.LOGOUT}`)).code===200&&e($()),s("/auth/login"))}catch(t){j.error({message:t.message}),console.error("First login password change error:",t)}finally{i(!1)}},isLoading:c}},B=n.div`
  width: 100%;
  min-height: 100vh;
  display: flex;
