import{r as g,u as x,A as y,B as F,n as c,F as n,k as f,m as u,j,D as b,o as P,s as e,z as k}from"./index-Cgakiq8m.js";import{B as p}from"./BaseForm-D5lkQNcM.js";import{F as v,B,g as S,e as T,a as w,c as h}from"./AuthForm.styles-DT_2koLn.js";import{q as $}from"./base-DTzaVxil.js";import{A as q}from"./AuthLayout.styles-JemlP71m.js";import"./BaseInput-BYNuzrse.js";import"./InputPassword-BGCdVBeQ.js";import"./BaseCheckbox-dN1ZBAP6.js";import"./index-UA613YsA.js";const E=()=>g.useMemo(()=>{const a=window.location.href,r=$.parseUrl(a);return{token:r.query.token||null,email:r.query.email||null}},[]),I=(s,a)=>{const r=x(),[i,t]=g.useState(!1);return{handleSubmit:async m=>{try{t(!0);const o=await y.post(`${F.RESET}`,{email:s,token_reset_pass:a,mat_khau_moi:m.password});o.code===200?(c.success({message:"Tạo thành công mật khẩu mới"}),r("/auth/login")):c.error({message:o.message})}catch(o){c.error({message:"Có lỗi xảy ra vui lòng thử lại sau",description:o.message}),console.error("New password error:",o)}finally{t(!1)}},isLoading:i}},_=j.div`
