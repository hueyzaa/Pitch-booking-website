import{u,r as f,A as j,B as F,n,F as a,k as g,m,j as h,D as y,o as p,s as e,z as b}from"./index-Cgakiq8m.js";import{B as l}from"./BaseForm-D5lkQNcM.js";import{F as w,B as P,g as S,e as k,a as c,b as d}from"./AuthForm.styles-DT_2koLn.js";import{A as B}from"./AuthLayout.styles-JemlP71m.js";import"./BaseInput-BYNuzrse.js";import"./InputPassword-BGCdVBeQ.js";import"./BaseCheckbox-dN1ZBAP6.js";import"./index-UA613YsA.js";const I=()=>{const s=u(),[t,r]=f.useState(!1);return{handleSubmit:async x=>{try{r(!0);const o=await j.post(`${F.FORGOTPASS}`,x);o.code===200?s("/auth/security-code"):o.message==="USER_NOT_FOUND"?n.error({message:"Không tìm thấy tài khoản"}):n.error({message:o.message})}catch(o){n.error({message:"Có lỗi xảy ra vui lòng thử lại sau",description:o.message}),console.error("Forgot password error:",o)}finally{r(!1)}},isLoading:t}},T=h.div`
