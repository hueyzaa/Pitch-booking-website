import{u as f,a as b,r as w,A as v,B as y,cb as $,n as j,j as n,m as a,k as d,F as o,D as F,q as _,o as x,s as r,N as z,z as P}from"./index-Cgakiq8m.js";import{B as l}from"./BaseForm-D5lkQNcM.js";import{p as u}from"./patterns-CiPeFOmw.js";import{C as k}from"./auth.api-kDhGu2-X.js";import{B as I}from"./BaseInput-BYNuzrse.js";import{I as L}from"./InputPassword-BGCdVBeQ.js";import{A as S}from"./AuthLayout-WY7KNEdV.js";import"./v4-C6aID195.js";import"./AuthLayout.styles-JemlP71m.js";const T=()=>{const s=f(),e=b(),[c,i]=w.useState(!1);return{handleSubmit:async p=>{try{i(!0);const t=await k({...p,is_first_change:1});(t==null?void 0:t.code)===200&&((await v.post(`${y.LOGOUT}`)).code===200&&e($()),s("/auth/login"))}catch(t){j.error({message:t.message}),console.error("First login password change error:",t)}finally{i(!1)}},isLoading:c}},B=n.div`
  width: 100%;
  min-height: 100vh;
  display: flex;
