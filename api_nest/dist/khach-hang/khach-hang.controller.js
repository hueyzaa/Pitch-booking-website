...
const khach_hang_dto_1 = require("./dto/khach-hang.dto");
const khach_hang_service_1 = require("./khach-hang.service");
let KhachHangController = KhachHangController_1 = class KhachHangController {
    constructor(khachHangService, helperService) {
        this.khachHangService = khachHangService;
        this.helperService = helperService;
        this.logger = new common_1.Logger(KhachHangController_1.name);
    }
    create(createKhachHangDto, user) {
    ...
    update(id, updateKhachHangDto, user) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [khach_hang_dto_1.CreateKhachHangDto, Object]),
...
], KhachHangController.prototype, "exportExcel", null);
__decorate([
    (0, common_1.HttpCode)(200),
    ...
    __metadata("design:returntype", void 0)
], KhachHangController.prototype, "findAllForSelectOptions", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, khach_hang_dto_1.UpdateKhachHangDto, Object]),
    __metadata("design:returntype", void 0)
...
KhachHangController = KhachHangController_1 = __decorate([
